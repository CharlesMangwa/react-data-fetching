...
export declare type Interceptor = (interceptedData: IInterceptedData) => IRequestToApi | void;
...
export declare type Method = "DELETE" | "FORM_DATA" | "GET" | "HEAD" | "PATCH" | "POST" | "PUT" | "TRACE";
